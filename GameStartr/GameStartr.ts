/// <reference path="References/EightBittr/EightBittr.ts" />
/// <reference path="References/AudioPlayr/AudioPlayr.ts" />
/// <reference path="References/ChangeLinr/ChangeLinr.ts" />
/// <reference path="References/FPSAnalyzr/FPSAnalyzr.ts" />
/// <reference path="References/GamesRunnr/GameSRunnr.ts" />
/// <reference path="References/GroupHoldr/GroupHoldr.ts" />
/// <reference path="References/InputWritr/InputWritr.ts" />
/// <reference path="References/LevelEditr/LevelEditr.ts" />
/// <reference path="References/NumberMakr/NumberMakr.ts" />
/// <reference path="References/MapsCreatr/MapsCreatr.ts" />
/// <reference path="References/MapScreenr/MapScreenr.ts" />
/// <reference path="References/MapsHandlr/MapsHandlr.ts" />
/// <reference path="References/ModAttachr/ModAttachr.ts" />
/// <reference path="References/PixelDrawr/PixelDrawr.ts" />
/// <reference path="References/PixelRendr/PixelRendr.ts" />
/// <reference path="References/ObjectMakr/ObjectMakr.ts" />
/// <reference path="References/StatsHoldr/StatsHoldr.ts" />
/// <reference path="References/StringFilr/StringFilr.ts" />
/// <reference path="References/ThingHittr/ThingHittr.ts" />
/// <reference path="References/TimeHandlr/TimeHandlr.ts" />
/// <reference path="References/QuadsKeepr/QuadsKeepr.ts" />
/// <reference path="References/WorldSeedr/WorldSeedr.ts" />
...
module GameStartr {
    ...
    export class GameStartr extends EightBittr.EightBittr implements IGameStartr {
        ...
        */
         ...
         */
        reset(GameStarter: GameStartr, customs: EightBittr.IEightBittrSettings) {
         ...
         */
        resetTimed(GameStarter: GameStartr, customs: EightBittr.IEightBittrSettings) {
        ...
        resetLevelEditor(GameStarter: GameStartr, customs: IGameStartrCustoms): void {
            GameStarter.LevelEditor = new LevelEditr.LevelEditr(GameStarter.proliferate({
                "GameStarter": GameStarter,
                "beautifier": window["js_beautify"] // Eventually there will be a custom beautifier... maybe
        ...
        */
        ...
        thingProcess(thing: IThing, title: string, settings: any, defaults: any): void {
            ...
            num = Math.floor(
                thing.height * (
                    thing.GameStarter.unitsize / thing.GameStarter.QuadsKeeper.getQuadrantHeight()
                    )
                );
            if (num > 0) {
                maxQuads += ((num + 1) * maxQuads / 2);
        ...
        mapPlaceRandomCommands(GameStarter: GameStartr, generatedCommands: WorldSeedr.ICommand[]): void {
            var MapsCreator = GameStarter.MapsCreator,
                MapsHandler = GameStarter.MapsHandler,
         ...
         * @param {GameStartr} GameStartr
         */
        canInputsTrigger(GameStarter: GameStartr) {
            return true;
        }
        ...
        */
         ...
         *                                 (by default, false).
         */
        setSize(thing: IThing, width: number, height: number, updateSprite?: boolean, updateSize?: boolean) {
        ...
        */
         ...
         *                              using Array.indexOf).
         */
        arrayDeleteThing(thing: IThing, array: any[], location = array.indexOf(thing)): void {
            if (location === -1) {
                return;
            }
